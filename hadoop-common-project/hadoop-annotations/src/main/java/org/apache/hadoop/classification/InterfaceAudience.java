 ...
 */
/*
* InterfaceAudience 注解说明类型的潜在使用范围
* InterfaceAudience.Public 对所有工程和应用可用
* InterfaceAudience.Private 只能用于某些特定工程和项目，比如Common,HDFS,MapReduce,Zookeeper,Hbase等
* InterfaceAudience.LimitedPrivate 只能用于Hadoop
* */
