 ...
 */
/*
* WritableComparator是RawComparator对WritableComparable的一个通用实现
* 功能一：提供compare()的默认实现，从数据流中反序列化要进行比较的对象，再调用对象的compare()方法(对象是Comparable的)
* 功能二：充当了RawComparator实例的一个工厂方法
* */
